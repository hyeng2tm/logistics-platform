    ...
    <div className="guide-container p-24">
      ...
      <div className="guide-content mt-8">
        <section className="guide-section card mb-6">
          <h2>
            <Cpu size={20} className="me-2" /> {t('development.backend.tech_stack', 'Backend Tech Stack')}
          </h2>
        ...
        <section className="guide-section card mb-6">
          <h2>
            <Database size={20} className="me-2" /> {t('development.backend.db_standard', 'Database Standards')}
          </h2>
        ...
        <section className="guide-section card mb-6">
          <h2>
            <Terminal size={20} className="me-2" /> {t('development.backend.api_standard', 'API Design')}
          </h2>
          <ul className="convention-list">
        ...
        <section className="guide-section card">
          <h2>
            <ShieldCheck size={20} className="me-2" /> {t('development.backend.security', 'Security Practices')}
          </h2>
