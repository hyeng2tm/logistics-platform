...
export default function Template4Page() {
  ...
  return (
    <div className="template-page fade-in template4-split-view-page p-6">
      <PageHeader 
      ...
      <div className="split-view-container mt-6">
            ...
            <div className="detail-view-container animate-slide-in">
              ...
              <div className="mt-24">
                <div className="form-field-group">
                  ...
                  <textarea 
                    className="form-input min-h-100 p-2 border rounded-md w-full" 
